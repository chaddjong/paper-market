...
export default function AdminMarketCard({ data }: any) {
  ...
  return (
    <TouchableOpacity
      ...
      onPress={() =>
        router.push({
          pathname: '/admin/product-detail', // Diarahkan ke detail
          params: { id: data.id },
        })
      }
    >
...
const styles = StyleSheet.create({
  ...
  condition: { fontSize: 13, marginTop: 4 },
  locationRow: { flexDirection: 'row', alignItems: 'center', marginTop: 4 },
  location: { fontSize: 12, marginLeft: 4, color: '#666', flex: 1 },
  weight: { marginTop: 4, fontWeight: '600', color: '#3FA34D' },
});